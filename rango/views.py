...
def index(request):
    ...
    # to the template engine. Do the same for pages ordering by views.
...
def add_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Save the new category to the database and confirm success in console.
...
def visitor_cookie_handler(request):
    ...
    # We use a helper function to obtain the visits cookie.
